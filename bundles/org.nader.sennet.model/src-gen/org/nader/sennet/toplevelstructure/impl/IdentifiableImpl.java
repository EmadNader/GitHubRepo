 ...
 * <ul>
 *   <li>{@link org.nader.sennet.toplevelstructure.impl.IdentifiableImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiableImpl extends MinimalEObjectImpl.Container implements Identifiable {
	...
	protected EClass eStaticClass() {
		return ToplevelstructurePackage.Literals.IDENTIFIABLE;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToplevelstructurePackage.IDENTIFIABLE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ToplevelstructurePackage.IDENTIFIABLE__ID:
				return getId();
		}
