 ...
 * @generated
 */
public class ToplevelstructureSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ToplevelstructureSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ToplevelstructurePackage.IDENTIFIABLE: {
				Identifiable identifiable = (Identifiable)theEObject;
				T result = caseIdentifiable(identifiable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ToplevelstructurePackage.NAMED_ELEMENT: {
			...
			case ToplevelstructurePackage.ABSTRACT_RESOURCE: {
